...
public class ReturnFileGenerator_Seq_Lock {
    ...
    public static void generateReturnFile() throws IOException {
        // Lock the sequence file to prevent concurrent access
        try (FileChannel channel = FileChannel.open(Paths.get(SEQUENCE_FILE_PATH), 
