...
public class ACHFileWriter {
    ...
    private static final String OUTPUT_FILE_PATH = "J:\\W.O.R.K___\\Sample\\Nach\\src\\main\\java\\main\\RETURN_OUTPUT\\API_ACH.txt"; 
...
//    }
    ...
    public void writeACHFile(String fileName, String settlementDate) {
        try (Connection conn = DriverManager.getConnection(DB_URL, USER, PASS);
             Statement stmt = conn.createStatement();
             BufferedWriter writer = new BufferedWriter(new FileWriter(OUTPUT_FILE_PATH))) {

            // Fetch header data using dynamic FILE_NAME and SETTLEMENT_DATE
            String headerQuery = "SELECT ACH_TRANSACTION_CODE, CONTROL1, CONTROL_CHARACTER, TOT_NO_OF_ITEMS, " +
                    ...
                    "SETTLEMENT_CYCLE, FILE_NAME, INW_GEN_DATE FROM ACHHEADER WHERE FILE_NAME ='" + fileName + "' AND SETTLEMENT_DATE ='" + settlementDate + "'";
            ...
            // Fetch data records with dynamic FILE_NAME
            String dataQuery = "SELECT ACH_TRANSACTION_CODE, DESTINATION_ACCOUNT_TYPE, LEDGER_FOLIO_NUMBER, BENEFICIARY_HOLDER_NAME," +
                    ...
                    "FROM ACHFILE WHERE FILE_NAME ='" + fileName + "'";
